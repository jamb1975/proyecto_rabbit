...
public final class Constants {
    ...
    public static final int UPDATE_SUCCESS_STATUS = 202;
    ...
    public static final String PASSWORD_UPDATE_SUCCESS_DETAIL = "Clave actualizada satisfactoriamente";
    ...
    static {
        ...
        errorMessages.put(PASSWORD_IS_NOT_VALID,
                new Error(VALIDATION_ERROR_STATUS, PASSWORD_IS_NOT_VALID, "Usuario o Clave Incorrecta."));
    }
