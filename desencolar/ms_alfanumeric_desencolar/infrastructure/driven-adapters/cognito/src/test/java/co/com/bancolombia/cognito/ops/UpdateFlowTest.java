...
public class UpdateFlowTest {
    ...
    void setUp() {
        ...
        updateFlow = new UpdateFlow(cognitoBaseProperties, asyncClient);
    }
    @Test
    void update() {

        String result = updateFlow.startUpdateFlow(passwordManagementRequest, messageId, consumer).block().getMeta().getMessageId();
