...
public class CalfRpcServerUpdateTest {
    ...
    public void setup() throws IOException {
        ...
        calfRpcServerUpdate = new CalfRpcServerUpdate(channel, queueName, rabbitToCognitoRepository);
    ...
    public void handleCall(){
        ...
        byte[] result =  calfRpcServerUpdate.handleCall(delivery, null);
    ...
    @Test
    public void update(){
        byte[] result =  calfRpcServerUpdate.update(passwordManagementRequest);
        String sApiresponse = new String(result, StandardCharsets.UTF_8);
        ApiResponse apiResponse = GSON.fromJson(sApiresponse, ApiResponse.class);
        assertEquals(messageId, apiResponse.getMeta().getMessageId());
    }
